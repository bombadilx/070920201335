                        ...
                        <div class="uofb cf">
                            <div class="l_col adrs">
                                ...
                                <form action="{{ route('handler') }}" method="post">
                                    ...
                                    <div class="field">
                                        <label>Name *</label>
                                        <input type="text" value="" palceholder="" class="vl_empty" name="name" />
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        ...
                                        <select name="area">
                                            <option class="plh"></option>
                                            <option>Moscow district</option>
                                            <option>Kiev district</option>
                                        </select>
                                    </div>
                            ...
                            <div class="r_col">
                                ...
                                <div class="uo_adr_list">
                                    @foreach($data as $address)
                                        <div class="item">
                                            <h3>{{$address->name}}</h3>
                                            <p>{{$address->city}}, {{$address->area}}, {{$address->street}}, {{$address->house}}, {{$address->information}}</p>
                                            <div class="actbox">
